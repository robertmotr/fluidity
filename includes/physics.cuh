...
__host__ void pressureProjectionCpu();

__global__ void pressureProjectionGpu();

__host__ void checkBoundariesCpu(Particle *particles, uint32 widthSz, 
                                 uint32 heightSz, bool freeSlip);

__global__ void checkBoundariesGpu(Particle *particles, uint32 widthSz, 
                                   uint32 heightSz, bool freeSlip);
